...
def parse_arguments():
    ...
    parser.add_argument('--db-name', default='reminicence',
                        help='Database name to create (default: reminicence)')
    parser.add_argument('--schema-name', default='reminicence_schema',
                        help='Schema name to create (default: reminicence_schema)'),
